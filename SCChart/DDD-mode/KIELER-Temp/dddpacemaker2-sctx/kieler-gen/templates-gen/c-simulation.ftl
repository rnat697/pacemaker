...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            ${tickdata_name}._DDDpacemaker_local_AVI_counter = item->valuedouble;
        }
        ...
        if(item != NULL) {
            ${tickdata_name}._g69_e3 = item->valueint;
        }
        // Receive _g7
        ...
        if(item != NULL) {
            ${tickdata_name}._g78_e4 = item->valueint;
        }
        // Receive _g79
        ...
        if(item != NULL) {
            ${tickdata_name}._pg43_e4 = item->valueint;
        }
        // Receive _pg50
...
void sendVariables(int send_interface) {
    ...
    cJSON_AddItemToObject(root, "_DDDpacemaker_local_AVI_counter", cJSON_CreateNumber(${tickdata_name}._DDDpacemaker_local_AVI_counter));
    ...
    // Send _g69_e3
    cJSON_AddItemToObject(root, "_g69_e3", cJSON_CreateBool(${tickdata_name}._g69_e3));
    // Send _g7
    ...
    // Send _g78_e4
    cJSON_AddItemToObject(root, "_g78_e4", cJSON_CreateBool(${tickdata_name}._g78_e4));
    // Send _g79
    ...
    // Send _pg43_e4
    cJSON_AddItemToObject(root, "_pg43_e4", cJSON_CreateBool(${tickdata_name}._pg43_e4));
    // Send _pg50
