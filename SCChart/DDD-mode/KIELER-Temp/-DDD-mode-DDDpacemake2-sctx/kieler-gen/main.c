...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            model._DDDpacemaker_local_VP_temp = item->valueint;
        }
        ...
        if(item != NULL) {
            model._DDDpacemaker_local_VRP_state = item->valueint;
        }
        ...
        if(item != NULL) {
            model._pg112 = item->valueint;
        }
        // Receive _pg11_e1
        item = cJSON_GetObjectItemCaseSensitive(root, "_pg11_e1");
        if(item != NULL) {
            model._pg11_e1 = item->valueint;
        }
        // Receive _pg12
...
void sendVariables(int send_interface) {
    ...
    cJSON_AddItemToObject(root, "_DDDpacemaker_local_AEI_state", cJSON_CreateBool(model._DDDpacemaker_local_AEI_state));
    // Send _DDDpacemaker_local_AP_temp
    cJSON_AddItemToObject(root, "_DDDpacemaker_local_AP_temp", cJSON_CreateBool(model._DDDpacemaker_local_AP_temp));
    ...
    cJSON_AddItemToObject(root, "_DDDpacemaker_local_LRI_state", cJSON_CreateBool(model._DDDpacemaker_local_LRI_state));
    // Send _DDDpacemaker_local_PVARP_state
    cJSON_AddItemToObject(root, "_DDDpacemaker_local_PVARP_state", cJSON_CreateBool(model._DDDpacemaker_local_PVARP_state));
    ...
    cJSON_AddItemToObject(root, "_DDDpacemaker_local_VP_temp", cJSON_CreateBool(model._DDDpacemaker_local_VP_temp));
    ...
    cJSON_AddItemToObject(root, "_DDDpacemaker_local_VRP_state", cJSON_CreateBool(model._DDDpacemaker_local_VRP_state));
    ...
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_AP_temp", cJSON_CreateBool(model._DDDpacemaker_local__pre_AP_temp));
    // Send _DDDpacemaker_local__pre_VP_temp
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_VP_temp", cJSON_CreateBool(model._DDDpacemaker_local__pre_VP_temp));
    // Send _DDDpacemaker_local__reg_AP_temp
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_AP_temp", cJSON_CreateBool(model._DDDpacemaker_local__reg_AP_temp));
    // Send _DDDpacemaker_local__reg_VP_temp
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_VP_temp", cJSON_CreateBool(model._DDDpacemaker_local__reg_VP_temp));
    ...
    // Send _g112_e1
    cJSON_AddItemToObject(root, "_g112_e1", cJSON_CreateBool(model._g112_e1));
    // Send _g113
    ...
    // Send _g121_e2
    cJSON_AddItemToObject(root, "_g121_e2", cJSON_CreateBool(model._g121_e2));
    // Send _g122
    ...
    // Send _g147_e2
    cJSON_AddItemToObject(root, "_g147_e2", cJSON_CreateBool(model._g147_e2));
    // Send _g148
    ...
    // Send _g161_e1
    cJSON_AddItemToObject(root, "_g161_e1", cJSON_CreateBool(model._g161_e1));
    // Send _g162
    ...
    // Send _g170_e2
    cJSON_AddItemToObject(root, "_g170_e2", cJSON_CreateBool(model._g170_e2));
    // Send _g18
    ...
    // Send _g30_e3
    cJSON_AddItemToObject(root, "_g30_e3", cJSON_CreateBool(model._g30_e3));
    // Send _g31
    ...
    // Send _g55_e1
    cJSON_AddItemToObject(root, "_g55_e1", cJSON_CreateBool(model._g55_e1));
    // Send _g56
    ...
    // Send _g65_e2
    cJSON_AddItemToObject(root, "_g65_e2", cJSON_CreateBool(model._g65_e2));
    // Send _g66
    ...
    // Send _pg112
    cJSON_AddItemToObject(root, "_pg112", cJSON_CreateBool(model._pg112));
    // Send _pg11_e1
    cJSON_AddItemToObject(root, "_pg11_e1", cJSON_CreateBool(model._pg11_e1));
    // Send _pg12
    ...
    // Send _pg132
    cJSON_AddItemToObject(root, "_pg132", cJSON_CreateBool(model._pg132));
    // Send _pg137
    ...
    // Send _pg147_e2
    cJSON_AddItemToObject(root, "_pg147_e2", cJSON_CreateBool(model._pg147_e2));
    // Send _pg15
    ...
    // Send _pg162
    cJSON_AddItemToObject(root, "_pg162", cJSON_CreateBool(model._pg162));
    // Send _pg164
    ...
    // Send _pg92_e2
    cJSON_AddItemToObject(root, "_pg92_e2", cJSON_CreateBool(model._pg92_e2));
    // Send _pg95
