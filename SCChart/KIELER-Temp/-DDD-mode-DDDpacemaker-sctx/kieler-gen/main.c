...
void sendVariables(int send_interface) {
    ...
    // Send AEI_counter
    cJSON_AddItemToObject(root, "AEI_counter", cJSON_CreateBool(model.AEI_counter));
    // Send AS
    cJSON_AddItemToObject(root, "AS", cJSON_CreateBool(model.AS));
    // Send AVI_counter
    cJSON_AddItemToObject(root, "AVI_counter", cJSON_CreateBool(model.AVI_counter));
    // Send LRI_counter
    cJSON_AddItemToObject(root, "LRI_counter", cJSON_CreateBool(model.LRI_counter));
    // Send PVARP_counter
    cJSON_AddItemToObject(root, "PVARP_counter", cJSON_CreateBool(model.PVARP_counter));
    // Send URI_counter
    cJSON_AddItemToObject(root, "URI_counter", cJSON_CreateBool(model.URI_counter));
    // Send VRP_counter
    cJSON_AddItemToObject(root, "VRP_counter", cJSON_CreateBool(model.VRP_counter));
    // Send VS
    ...
    // Send AEI_start
    cJSON_AddItemToObject(root, "AEI_start", cJSON_CreateBool(model.AEI_start));
    // Send AEI_stop
    cJSON_AddItemToObject(root, "AEI_stop", cJSON_CreateBool(model.AEI_stop));
    // Send AVI_extend
    cJSON_AddItemToObject(root, "AVI_extend", cJSON_CreateBool(model.AVI_extend));
    // Send AVI_start
    cJSON_AddItemToObject(root, "AVI_start", cJSON_CreateBool(model.AVI_start));
    // Send AVI_stop
    cJSON_AddItemToObject(root, "AVI_stop", cJSON_CreateBool(model.AVI_stop));
    // Send LRI_reset
    cJSON_AddItemToObject(root, "LRI_reset", cJSON_CreateBool(model.LRI_reset));
    // Send LRI_start
    cJSON_AddItemToObject(root, "LRI_start", cJSON_CreateBool(model.LRI_start));
    // Send LRI_stop
    cJSON_AddItemToObject(root, "LRI_stop", cJSON_CreateBool(model.LRI_stop));
    // Send PVARP_start
    cJSON_AddItemToObject(root, "PVARP_start", cJSON_CreateBool(model.PVARP_start));
    // Send PVARP_stop
    cJSON_AddItemToObject(root, "PVARP_stop", cJSON_CreateBool(model.PVARP_stop));
    // Send URI_start
    cJSON_AddItemToObject(root, "URI_start", cJSON_CreateBool(model.URI_start));
    // Send URI_stop
    cJSON_AddItemToObject(root, "URI_stop", cJSON_CreateBool(model.URI_stop));
    // Send VRP_start
    cJSON_AddItemToObject(root, "VRP_start", cJSON_CreateBool(model.VRP_start));
    // Send VRP_stop
    cJSON_AddItemToObject(root, "VRP_stop", cJSON_CreateBool(model.VRP_stop));
    // Send _GO
    ...
    // Send doneAS
    cJSON_AddItemToObject(root, "doneAS", cJSON_CreateBool(model.doneAS));
    // Send doneAVI
    cJSON_AddItemToObject(root, "doneAVI", cJSON_CreateBool(model.doneAVI));
    // Send doneVS
    cJSON_AddItemToObject(root, "doneVS", cJSON_CreateBool(model.doneVS));
