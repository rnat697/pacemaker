...
<#macro simulation_body position>
    ...
    private static void receiveVariables() {
        try {
            ...
            // Receive _g243
            if (json.has("_g243")) {
                ${tickdata_name}._g243 = json.getBoolean("_g243");
            }
            // Receive _g251
            if (json.has("_g251")) {
            ...
            // Receive _g255
            if (json.has("_g255")) {
                ${tickdata_name}._g255 = json.getBoolean("_g255");
            }
            // Receive _g259
            if (json.has("_g259")) {
            ...
            // Receive _pg239
            if (json.has("_pg239")) {
                ${tickdata_name}._pg239 = json.getBoolean("_pg239");
            }
            // Receive _pg255
            if (json.has("_pg255")) {
                ${tickdata_name}._pg255 = json.getBoolean("_pg255");
            }
            // Receive _pg263
            if (json.has("_pg263")) {
    ...
    private static void sendVariables() {
        ...
        // Send _g243
        json.put("_g243", JSONObject.wrap(${tickdata_name}._g243));
        // Send _g251
        json.put("_g251", JSONObject.wrap(${tickdata_name}._g251));
        // Send _g255
        json.put("_g255", JSONObject.wrap(${tickdata_name}._g255));
        // Send _g259
        ...
        // Send _pg239
        json.put("_pg239", JSONObject.wrap(${tickdata_name}._pg239));
        // Send _pg255
        json.put("_pg255", JSONObject.wrap(${tickdata_name}._pg255));
        // Send _pg263
