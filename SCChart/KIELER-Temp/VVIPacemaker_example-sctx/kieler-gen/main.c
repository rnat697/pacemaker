...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            model.LRITO = item->valueint;
        }
        // Receive VRPTO
        item = cJSON_GetObjectItemCaseSensitive(root, "VRPTO");
        if(item != NULL) {
            model.VRPTO = item->valueint;
        }
        // Receive VSense
        ...
        if(item != NULL) {
            model._VVIPacemaker_example_local_LRI_ex = item->valueint;
        }
        ...
        if(item != NULL) {
            model._VVIPacemaker_example_local_LRI_start = item->valueint;
        }
        ...
        if(item != NULL) {
            model._VVIPacemaker_example_local_VRP_start = item->valueint;
        }
        ...
        if(item != NULL) {
            model._VVIPacemaker_example_local_VRP_stop = item->valueint;
        }
        // Receive _cg10
...
void sendVariables(int send_interface) {
    ...
    // Send LRITO
    cJSON_AddItemToObject(root, "LRITO", cJSON_CreateBool(model.LRITO));
    // Send VRPTO
    cJSON_AddItemToObject(root, "VRPTO", cJSON_CreateBool(model.VRPTO));
    // Send VSense
    ...
    cJSON_AddItemToObject(root, "_VVIPacemaker_example_local_LRI_ex", cJSON_CreateBool(model._VVIPacemaker_example_local_LRI_ex));
    // Send _VVIPacemaker_example_local_LRI_start
    cJSON_AddItemToObject(root, "_VVIPacemaker_example_local_LRI_start", cJSON_CreateBool(model._VVIPacemaker_example_local_LRI_start));
    // Send _VVIPacemaker_example_local_LRI_stop
    cJSON_AddItemToObject(root, "_VVIPacemaker_example_local_LRI_stop", cJSON_CreateBool(model._VVIPacemaker_example_local_LRI_stop));
    // Send _VVIPacemaker_example_local_VRP_ex
    cJSON_AddItemToObject(root, "_VVIPacemaker_example_local_VRP_ex", cJSON_CreateBool(model._VVIPacemaker_example_local_VRP_ex));
    // Send _VVIPacemaker_example_local_VRP_start
    cJSON_AddItemToObject(root, "_VVIPacemaker_example_local_VRP_start", cJSON_CreateBool(model._VVIPacemaker_example_local_VRP_start));
    // Send _VVIPacemaker_example_local_VRP_stop
    cJSON_AddItemToObject(root, "_VVIPacemaker_example_local_VRP_stop", cJSON_CreateBool(model._VVIPacemaker_example_local_VRP_stop));
    // Send _cg10
