...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            model._DDDpacemaker_local__pre_PVARP_start = item->valueint;
        }
        ...
        if(item != NULL) {
            model._DDDpacemaker_local__reg_PVARP_start = item->valueint;
        }
        ...
        if(item != NULL) {
            model._cg187 = item->valueint;
        }
        // Receive _cg192
        item = cJSON_GetObjectItemCaseSensitive(root, "_cg192");
        if(item != NULL) {
            model._cg192 = item->valueint;
        }
        // Receive _cg195
        ...
        if(item != NULL) {
            model._cg211 = item->valueint;
        }
        // Receive _cg214
        item = cJSON_GetObjectItemCaseSensitive(root, "_cg214");
        if(item != NULL) {
            model._cg214 = item->valueint;
        }
        // Receive _cg26
        ...
        if(item != NULL) {
            model._g197_e1 = item->valueint;
        }
        // Receive _g198
        item = cJSON_GetObjectItemCaseSensitive(root, "_g198");
        if(item != NULL) {
            model._g198 = item->valueint;
        }
        // Receive _g199
        ...
        if(item != NULL) {
            model._g206 = item->valueint;
        }
        // Receive _g206_e2
        item = cJSON_GetObjectItemCaseSensitive(root, "_g206_e2");
        if(item != NULL) {
            model._g206_e2 = item->valueint;
        }
        // Receive _g207
...
void sendVariables(int send_interface) {
    ...
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__Atrig10", cJSON_CreateBool(model._DDDpacemaker_local__Atrig10));
    // Send _DDDpacemaker_local__Atrig11
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__Atrig11", cJSON_CreateBool(model._DDDpacemaker_local__Atrig11));
    ...
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__Atrig5", cJSON_CreateBool(model._DDDpacemaker_local__Atrig5));
    // Send _DDDpacemaker_local__Atrig6
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__Atrig6", cJSON_CreateBool(model._DDDpacemaker_local__Atrig6));
    // Send _DDDpacemaker_local__Atrig7
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__Atrig7", cJSON_CreateBool(model._DDDpacemaker_local__Atrig7));
    // Send _DDDpacemaker_local__Atrig8
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__Atrig8", cJSON_CreateBool(model._DDDpacemaker_local__Atrig8));
    // Send _DDDpacemaker_local__Atrig9
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__Atrig9", cJSON_CreateBool(model._DDDpacemaker_local__Atrig9));
    // Send _DDDpacemaker_local__pre_AVI_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_AVI_start", cJSON_CreateBool(model._DDDpacemaker_local__pre_AVI_start));
    // Send _DDDpacemaker_local__pre_AVI_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_AVI_stop", cJSON_CreateBool(model._DDDpacemaker_local__pre_AVI_stop));
    // Send _DDDpacemaker_local__pre_LRI_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_LRI_start", cJSON_CreateBool(model._DDDpacemaker_local__pre_LRI_start));
    // Send _DDDpacemaker_local__pre_LRI_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_LRI_stop", cJSON_CreateBool(model._DDDpacemaker_local__pre_LRI_stop));
    // Send _DDDpacemaker_local__pre_PVARP_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_PVARP_start", cJSON_CreateBool(model._DDDpacemaker_local__pre_PVARP_start));
    // Send _DDDpacemaker_local__pre_PVARP_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_PVARP_stop", cJSON_CreateBool(model._DDDpacemaker_local__pre_PVARP_stop));
    // Send _DDDpacemaker_local__pre_URI_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_URI_start", cJSON_CreateBool(model._DDDpacemaker_local__pre_URI_start));
    // Send _DDDpacemaker_local__pre_URI_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_URI_stop", cJSON_CreateBool(model._DDDpacemaker_local__pre_URI_stop));
    // Send _DDDpacemaker_local__pre_VRP_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_VRP_start", cJSON_CreateBool(model._DDDpacemaker_local__pre_VRP_start));
    // Send _DDDpacemaker_local__pre_VRP_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_VRP_stop", cJSON_CreateBool(model._DDDpacemaker_local__pre_VRP_stop));
    // Send _DDDpacemaker_local__pre_real_AS
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_real_AS", cJSON_CreateBool(model._DDDpacemaker_local__pre_real_AS));
    // Send _DDDpacemaker_local__pre_real_VS
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__pre_real_VS", cJSON_CreateBool(model._DDDpacemaker_local__pre_real_VS));
    // Send _DDDpacemaker_local__reg_AVI_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_AVI_start", cJSON_CreateBool(model._DDDpacemaker_local__reg_AVI_start));
    // Send _DDDpacemaker_local__reg_AVI_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_AVI_stop", cJSON_CreateBool(model._DDDpacemaker_local__reg_AVI_stop));
    // Send _DDDpacemaker_local__reg_LRI_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_LRI_start", cJSON_CreateBool(model._DDDpacemaker_local__reg_LRI_start));
    // Send _DDDpacemaker_local__reg_LRI_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_LRI_stop", cJSON_CreateBool(model._DDDpacemaker_local__reg_LRI_stop));
    // Send _DDDpacemaker_local__reg_PVARP_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_PVARP_start", cJSON_CreateBool(model._DDDpacemaker_local__reg_PVARP_start));
    // Send _DDDpacemaker_local__reg_PVARP_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_PVARP_stop", cJSON_CreateBool(model._DDDpacemaker_local__reg_PVARP_stop));
    // Send _DDDpacemaker_local__reg_URI_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_URI_start", cJSON_CreateBool(model._DDDpacemaker_local__reg_URI_start));
    // Send _DDDpacemaker_local__reg_URI_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_URI_stop", cJSON_CreateBool(model._DDDpacemaker_local__reg_URI_stop));
    // Send _DDDpacemaker_local__reg_VRP_start
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_VRP_start", cJSON_CreateBool(model._DDDpacemaker_local__reg_VRP_start));
    // Send _DDDpacemaker_local__reg_VRP_stop
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_VRP_stop", cJSON_CreateBool(model._DDDpacemaker_local__reg_VRP_stop));
    // Send _DDDpacemaker_local__reg_real_AS
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_real_AS", cJSON_CreateBool(model._DDDpacemaker_local__reg_real_AS));
    // Send _DDDpacemaker_local__reg_real_VS
    cJSON_AddItemToObject(root, "_DDDpacemaker_local__reg_real_VS", cJSON_CreateBool(model._DDDpacemaker_local__reg_real_VS));
    ...
    // Send _cg187
    cJSON_AddItemToObject(root, "_cg187", cJSON_CreateBool(model._cg187));
    // Send _cg192
    cJSON_AddItemToObject(root, "_cg192", cJSON_CreateBool(model._cg192));
    // Send _cg195
    cJSON_AddItemToObject(root, "_cg195", cJSON_CreateBool(model._cg195));
    // Send _cg196
    cJSON_AddItemToObject(root, "_cg196", cJSON_CreateBool(model._cg196));
    // Send _cg200
    cJSON_AddItemToObject(root, "_cg200", cJSON_CreateBool(model._cg200));
    // Send _cg205
    cJSON_AddItemToObject(root, "_cg205", cJSON_CreateBool(model._cg205));
    // Send _cg21
    cJSON_AddItemToObject(root, "_cg21", cJSON_CreateBool(model._cg21));
    // Send _cg211
    cJSON_AddItemToObject(root, "_cg211", cJSON_CreateBool(model._cg211));
    // Send _cg214
    cJSON_AddItemToObject(root, "_cg214", cJSON_CreateBool(model._cg214));
    // Send _cg26
    ...
    // Send _g104_e2
    cJSON_AddItemToObject(root, "_g104_e2", cJSON_CreateBool(model._g104_e2));
    // Send _g105
    ...
    // Send _g129
    cJSON_AddItemToObject(root, "_g129", cJSON_CreateBool(model._g129));
    // Send _g13
    ...
    // Send _g165_e1
    cJSON_AddItemToObject(root, "_g165_e1", cJSON_CreateBool(model._g165_e1));
    // Send _g166
    ...
    // Send _g175_e2
    cJSON_AddItemToObject(root, "_g175_e2", cJSON_CreateBool(model._g175_e2));
    // Send _g176
    ...
    // Send _g18_e2
    cJSON_AddItemToObject(root, "_g18_e2", cJSON_CreateBool(model._g18_e2));
    // Send _g19
    ...
    // Send _g197_e1
    cJSON_AddItemToObject(root, "_g197_e1", cJSON_CreateBool(model._g197_e1));
    // Send _g198
    cJSON_AddItemToObject(root, "_g198", cJSON_CreateBool(model._g198));
    // Send _g199
    cJSON_AddItemToObject(root, "_g199", cJSON_CreateBool(model._g199));
    // Send _g20
    cJSON_AddItemToObject(root, "_g20", cJSON_CreateBool(model._g20));
    // Send _g200
    cJSON_AddItemToObject(root, "_g200", cJSON_CreateBool(model._g200));
    // Send _g201
    cJSON_AddItemToObject(root, "_g201", cJSON_CreateBool(model._g201));
    // Send _g202
    cJSON_AddItemToObject(root, "_g202", cJSON_CreateBool(model._g202));
    // Send _g205
    cJSON_AddItemToObject(root, "_g205", cJSON_CreateBool(model._g205));
    // Send _g206
    cJSON_AddItemToObject(root, "_g206", cJSON_CreateBool(model._g206));
    // Send _g206_e2
    cJSON_AddItemToObject(root, "_g206_e2", cJSON_CreateBool(model._g206_e2));
    // Send _g207
    cJSON_AddItemToObject(root, "_g207", cJSON_CreateBool(model._g207));
    // Send _g21
    cJSON_AddItemToObject(root, "_g21", cJSON_CreateBool(model._g21));
    // Send _g211
    cJSON_AddItemToObject(root, "_g211", cJSON_CreateBool(model._g211));
    // Send _g212
    cJSON_AddItemToObject(root, "_g212", cJSON_CreateBool(model._g212));
    // Send _g214
    cJSON_AddItemToObject(root, "_g214", cJSON_CreateBool(model._g214));
    // Send _g215
    cJSON_AddItemToObject(root, "_g215", cJSON_CreateBool(model._g215));
    // Send _g22
    cJSON_AddItemToObject(root, "_g22", cJSON_CreateBool(model._g22));
    // Send _g23
    cJSON_AddItemToObject(root, "_g23", cJSON_CreateBool(model._g23));
    // Send _g231
    cJSON_AddItemToObject(root, "_g231", cJSON_CreateBool(model._g231));
    // Send _g235
    cJSON_AddItemToObject(root, "_g235", cJSON_CreateBool(model._g235));
    // Send _g239
    cJSON_AddItemToObject(root, "_g239", cJSON_CreateBool(model._g239));
    // Send _g247
    cJSON_AddItemToObject(root, "_g247", cJSON_CreateBool(model._g247));
    // Send _g251
    cJSON_AddItemToObject(root, "_g251", cJSON_CreateBool(model._g251));
    // Send _g259
    cJSON_AddItemToObject(root, "_g259", cJSON_CreateBool(model._g259));
    // Send _g26
    cJSON_AddItemToObject(root, "_g26", cJSON_CreateBool(model._g26));
    // Send _g263
    cJSON_AddItemToObject(root, "_g263", cJSON_CreateBool(model._g263));
    // Send _g27
    cJSON_AddItemToObject(root, "_g27", cJSON_CreateBool(model._g27));
    // Send _g279
    cJSON_AddItemToObject(root, "_g279", cJSON_CreateBool(model._g279));
    // Send _g28
    cJSON_AddItemToObject(root, "_g28", cJSON_CreateBool(model._g28));
    // Send _g283
    cJSON_AddItemToObject(root, "_g283", cJSON_CreateBool(model._g283));
    // Send _g287
    cJSON_AddItemToObject(root, "_g287", cJSON_CreateBool(model._g287));
    // Send _g28_e3
    cJSON_AddItemToObject(root, "_g28_e3", cJSON_CreateBool(model._g28_e3));
    // Send _g29
    cJSON_AddItemToObject(root, "_g29", cJSON_CreateBool(model._g29));
    // Send _g295
    cJSON_AddItemToObject(root, "_g295", cJSON_CreateBool(model._g295));
    // Send _g30
    ...
    // Send _g95_e1
    cJSON_AddItemToObject(root, "_g95_e1", cJSON_CreateBool(model._g95_e1));
    // Send _g96
    ...
    // Send _g9_e1
    cJSON_AddItemToObject(root, "_g9_e1", cJSON_CreateBool(model._g9_e1));
    // Send _pg10
    ...
    // Send _pg119
    cJSON_AddItemToObject(root, "_pg119", cJSON_CreateBool(model._pg119));
    // Send _pg122
    ...
    // Send _pg153
    cJSON_AddItemToObject(root, "_pg153", cJSON_CreateBool(model._pg153));
    // Send _pg156
    cJSON_AddItemToObject(root, "_pg156", cJSON_CreateBool(model._pg156));
    // Send _pg164
    cJSON_AddItemToObject(root, "_pg164", cJSON_CreateBool(model._pg164));
    // Send _pg165
    cJSON_AddItemToObject(root, "_pg165", cJSON_CreateBool(model._pg165));
    // Send _pg166
    cJSON_AddItemToObject(root, "_pg166", cJSON_CreateBool(model._pg166));
    // Send _pg169
    ...
    // Send _pg180
    cJSON_AddItemToObject(root, "_pg180", cJSON_CreateBool(model._pg180));
    // Send _pg184
    cJSON_AddItemToObject(root, "_pg184", cJSON_CreateBool(model._pg184));
    // Send _pg18_e2
    cJSON_AddItemToObject(root, "_pg18_e2", cJSON_CreateBool(model._pg18_e2));
    // Send _pg19
    cJSON_AddItemToObject(root, "_pg19", cJSON_CreateBool(model._pg19));
    // Send _pg192
    cJSON_AddItemToObject(root, "_pg192", cJSON_CreateBool(model._pg192));
    // Send _pg197_e1
    cJSON_AddItemToObject(root, "_pg197_e1", cJSON_CreateBool(model._pg197_e1));
    // Send _pg198
    cJSON_AddItemToObject(root, "_pg198", cJSON_CreateBool(model._pg198));
    // Send _pg200
    cJSON_AddItemToObject(root, "_pg200", cJSON_CreateBool(model._pg200));
    // Send _pg201
    cJSON_AddItemToObject(root, "_pg201", cJSON_CreateBool(model._pg201));
    // Send _pg21
    cJSON_AddItemToObject(root, "_pg21", cJSON_CreateBool(model._pg21));
    // Send _pg211
    cJSON_AddItemToObject(root, "_pg211", cJSON_CreateBool(model._pg211));
    // Send _pg212
    cJSON_AddItemToObject(root, "_pg212", cJSON_CreateBool(model._pg212));
    // Send _pg214
    cJSON_AddItemToObject(root, "_pg214", cJSON_CreateBool(model._pg214));
    // Send _pg215
    cJSON_AddItemToObject(root, "_pg215", cJSON_CreateBool(model._pg215));
    // Send _pg22
    cJSON_AddItemToObject(root, "_pg22", cJSON_CreateBool(model._pg22));
    // Send _pg235
    cJSON_AddItemToObject(root, "_pg235", cJSON_CreateBool(model._pg235));
    // Send _pg251
    cJSON_AddItemToObject(root, "_pg251", cJSON_CreateBool(model._pg251));
    // Send _pg263
    cJSON_AddItemToObject(root, "_pg263", cJSON_CreateBool(model._pg263));
    // Send _pg279
    cJSON_AddItemToObject(root, "_pg279", cJSON_CreateBool(model._pg279));
    // Send _pg283
    cJSON_AddItemToObject(root, "_pg283", cJSON_CreateBool(model._pg283));
    // Send _pg287
    cJSON_AddItemToObject(root, "_pg287", cJSON_CreateBool(model._pg287));
    // Send _pg33
    ...
    // Send _pg63
    cJSON_AddItemToObject(root, "_pg63", cJSON_CreateBool(model._pg63));
    // Send _pg85
    cJSON_AddItemToObject(root, "_pg85", cJSON_CreateBool(model._pg85));
    // Send _pg87
    cJSON_AddItemToObject(root, "_pg87", cJSON_CreateBool(model._pg87));
    // Send _pg90
