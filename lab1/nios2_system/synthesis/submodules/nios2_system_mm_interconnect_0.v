...
module nios2_system_mm_interconnect_0 (
	...
	wire          cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> led_green_s1_agent:cp_valid
	wire  [102:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> led_green_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                     // led_green_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [11:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> led_green_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> led_green_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> led_green_s1_agent:cp_endofpacket
	...
	wire          led_green_s1_agent_rp_valid;                                               // led_green_s1_agent:rp_valid -> router_011:sink_valid
	wire  [102:0] led_green_s1_agent_rp_data;                                                // led_green_s1_agent:rp_data -> router_011:sink_data
	wire          led_green_s1_agent_rp_ready;                                               // router_011:sink_ready -> led_green_s1_agent:rp_ready
	wire          led_green_s1_agent_rp_startofpacket;                                       // led_green_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          led_green_s1_agent_rp_endofpacket;                                         // led_green_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          led_green_s1_agent_rdata_fifo_src_valid;                                   // led_green_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] led_green_s1_agent_rdata_fifo_src_data;                                    // led_green_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          led_green_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_009:in_0_ready -> led_green_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                         // avalon_st_adapter_009:out_0_valid -> led_green_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                          // avalon_st_adapter_009:out_0_data -> led_green_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                         // led_green_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                         // avalon_st_adapter_009:out_0_error -> led_green_s1_agent:rdata_fifo_sink_error
